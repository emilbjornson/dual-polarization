...
hold on
m4=plot(Mrange, Rate_woSIC_MRsum(:,1),'k--' );
hold on
m5=plot(Mrange, Rate_th_MRsum,'sb' );
ylim([0 70])
legend([m1,m2,m3,m4,m5],{'MMSE Precoding ',' ZF Precoding','MR Precoding', 'without SIC', 'Closed-form MR'},'Interpreter','latex','Location','NorthEast');
xlabel('Number of Antennas (M)','Interpreter','latex')
ylabel('Average Downlink Sum SE [bps/Hz]','Interpreter','latex');
...
saveas(fig,'figDownlink','fig');
saveas(fig,'figDownlink','epsc');
