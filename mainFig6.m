...
figure;
plot(Mrange, Rate_SIC_MMSEsum(:,1),'r-')
hold on
plot(Mrange, Rate_woSIC_MMSEsum(:,1),'k--')
hold on
plot(Mrange, Rate_SIC_ZFsum(:,1),'r-o')
hold on
plot(Mrange, Rate_woSIC_ZFsum(:,1),'k--' )
hold on
plot(Mrange, Rate_SIC_MRsum(:,1),'r->')
hold on
plot(Mrange, Rate_woSIC_MRsum(:,1),'k--' )
hold on
plot(Mrange, Rate_SIC_MMSEsum(:,2),'b-')
hold on
plot(Mrange, Rate_woSIC_MMSEsum(:,2),'k--')
hold on
plot(Mrange, Rate_SIC_ZFsum(:,2),'b-o')
hold on
plot(Mrange, Rate_woSIC_ZFsum(:,2),'k--' )
hold on
plot(Mrange, Rate_SIC_MRsum(:,2),'b->')
hold on
plot(Mrange, Rate_woSIC_MRsum(:,2),'k--' )
% hold on
% plot(Mrange, Rate_th_MRsum,'sb' )
legend({'MMSE Precoding, XPD $= \infty$ ',' ZF Precoding, XPD $= \infty$','MR Precoding, XPD $= \infty$',...
    'MMSE Precoding, XPD $= 0$ dB ',' ZF Precoding, XPD $= 0$ dB','MR Precoding, XPD $= 0$ dB','without SIC'},'Interpreter','latex','Location','NorthEast');
...
% print(fig,'fig1','-depsc'); %This is an alternative way to write the same thing
saveas(fig,'figDownlinkXPD','fig');
saveas(fig,'figDownlinkXPD','epsc');
