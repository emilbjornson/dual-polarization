...
%Unipolarized 
p_unipl=2*p1;%DO NOT FORGET TO CHANGE THIS FOR M/2 (2*p1) and M (p1)
...
for n=1:nbrOfSetups
    ...
    for m=1:length(Mrange)
        ...
        Muni=M/2; %Compare with unipolarized antennas, M or M/2
...
print(fig,'figDPvsUP2','-depsc'); %This is an alternative way to write the same thing
saveas(fig,'figDPvsUP2.fig');
